...
export async function getPicture() {
  try {
    ...
    const response = await fetch(`/api/${userData.profile_picture}`)
    if (response.ok) {
...
export async function acceptInvitation(id) {
  try {
    ...
    const response = await fetch("/api/relationships/invite/accept/", {
      method: "PATCH",
...
export async function refuseInvitation(id) {
  try {
    ...
    const response = await fetch("/api/relationships/invite/refuse/", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ "invitation_id": id })
    })
...
export async function cancelInvitation(id) {
  try {
    ...
    const response = await fetch("/api/relationships/invite/cancel/", {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ "invitation_id": id })
    })
...
export async function removeFriend(id) {
  try {
    ...
    const response = await fetch("/api/relationships/unfriend/", {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
