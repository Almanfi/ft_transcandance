...
from ..websockets import MessagingSocket, GameSocket, PongSocket, MatchmakingSocket, TournamentMakingSocket, TournamentSocket, RollSocket, OsnierTournamentMakingSocket, OsnierMatchmakingSocket
...
urlpatterns = [
	...
	path("ws/matchmaking/osnier/", OsnierMatchmakingSocket.as_asgi()),
    path("ws/tournamentmaking/pong/", TournamentMakingSocket.as_asgi()),
	path("ws/tournamentmaking/osnier/", OsnierTournamentMakingSocket.as_asgi()),
