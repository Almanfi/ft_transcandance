const countries = ["Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Anguilla",
  ...
  "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "North Korea", "Norway",
  "Oman", "Pakistan", "Palau", "Palestine", "Panama", "Papua New Guinea", "Paraguay", "Peru",
  "Philippines", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", "Romania", "Russia",
  "Rwanda", "Saint Pierre & Miquelon", "Samoa", "San Marino", "Sao Tome and Principe",
  ...
  "Togo", "Tonga", "Trinidad & Tobago", "Tunisia", "Turkey", "Turkmenistan", "Turks & Caicos", "Tuvalu",
...
document.getElementById("myInput").addEventListener("input", debounce((e) => {
  ...
  if (value) {
    const matches = countries.filter(country => country.toLowerCase().startsWith(value)).slice(0, 10);
